...
│   ├── compiler.go         # Compile, Build, Run methods
│   └── compiler_test.go    # Golden file tests
├── pkg/
│   ├── token/              # Token types, keywords, positions
│   │   ├── token.go
│   │   └── tokentype_string.go  # Generated by stringer
│   ├── lexer/              # iter.Seq-based tokenizer
│   │   ├── lexer.go
│   │   └── lexer_test.go
│   ├── ast/                # AST node definitions
│   │   ├── ast.go          # Expr, Stmt, Pattern nodes
│   │   ├── types.go        # TypeExpr, Param, BasicType
│   │   └── walk.go         # AST tree walker
...
│   ├── linter/             # Code linter
│   │   └── linter.go
│   └── mutation/           # Mutation testing support
│       └── mutation.go
├── runtime/
│   ├── meowrt/             # Core runtime: Value, operators, builtins
│   │   ├── value.go        # Value interface, Int, Float, String, Bool, etc.
│   │   ├── operators.go    # Arithmetic, comparison, logical operators
│   │   ├── builtins.go     # nya, hiss, gag, len, to_int, etc.
│   │   └── list.go         # lick, picky, curl, head, tail, append
│   ├── file/               # File I/O (snoop, stalk)
│   │   └── file.go
│   ├── http/               # HTTP client (pounce, toss, knead, swat, prowl)
│   │   └── http.go
│   ├── testing/            # Test framework (judge, expect, refuse, run)
│   │   └── testing.go
│   └── coverage/           # Statement coverage tracking
│       └── coverage.go
├── examples/               # Sample .nyan programs
├── testdata/               # Golden file tests (.nyan + .golden)
└── docs/                   # Documentation
```
